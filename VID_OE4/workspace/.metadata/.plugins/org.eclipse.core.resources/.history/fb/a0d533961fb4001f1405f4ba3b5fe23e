...
int configureStartTPG()
{
	...
	XV_tpg_Set_bckgndId(tpgInst, XTPG_BKGND_RAINBOW_COLOR);//XTPG_BKGND_RAINBOW_COLOR //XTPG_BKGND_CHECKER_BOARD //XTPG_BKGND_HV_RAMP//XTPG_BKGND_H_RAMP//XTPG_BKGND_RAINBOW_COLOR
