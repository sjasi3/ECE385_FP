...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/draw_bg/draw_bg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source video_top.tcl -notrace
