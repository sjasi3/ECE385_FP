...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/draw_bg/draw_bg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_top.tcl
