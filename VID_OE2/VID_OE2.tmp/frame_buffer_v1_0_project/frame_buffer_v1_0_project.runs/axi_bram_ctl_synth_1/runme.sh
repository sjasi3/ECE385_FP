...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/VID_OE2/VID_OE2.tmp/frame_buffer_v1_0_project/frame_buffer_v1_0_project.runs/axi_bram_ctl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_bram_ctl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_bram_ctl.tcl
