...
#
# Generated by export_simulation on Thu Dec 12 16:41:25 CST 2024
#
################################################################################
...
'-reset_run' switch to the './bg_rom.sh' script.
...
./bg_rom.sh -noclean_files

For more information on the script, please type './bg_rom.sh -help'.
