...
HD_PWD='C:/Users/sjasi3/ECE385_FP/RTL_DDR3/RTL_DDR3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rtl_ddr3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rtl_ddr3_top.tcl -notrace
