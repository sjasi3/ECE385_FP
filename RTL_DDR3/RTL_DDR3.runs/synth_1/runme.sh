...
HD_PWD='C:/Users/sjasi3/ECE385_FP/RTL_DDR3/RTL_DDR3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rtl_ddr3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rtl_ddr3_top.tcl
