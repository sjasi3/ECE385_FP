...
module vid_oe3_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_729_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_condition_412 = ((icmp_ln729_fu_432_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1839_fu_448_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ovrlayId_load_read_reg_826 == 8'd1));
end

always @ (*) begin
    ap_condition_669 = ((icmp_ln729_fu_432_p2 == 1'd0) & (icmp_ln1839_fu_448_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (ovrlayId_load_read_reg_826 == 8'd1));
end
...
assign empty_fu_728_p3 = ((tobool_read_reg_835[0:0] == 1'b1) ? ap_phi_reg_pp0_iter3_pix_val_V_3_reg_357 : select_ln1946_fu_721_p3);
...
assign pixOut_val_V_13_fu_693_p3 = ((and4_i_read_reg_847[0:0] == 1'b1) ? 8'd0 : ap_phi_reg_pp0_iter3_pix_val_V_reg_376);

assign pixOut_val_V_14_fu_700_p3 = ((and26_i_read_reg_842[0:0] == 1'b1) ? 8'd0 : ap_phi_reg_pp0_iter3_pix_val_V_4_reg_340);

assign pixOut_val_V_15_fu_707_p3 = ((tobool_read_reg_835[0:0] == 1'b1) ? ap_phi_reg_pp0_iter3_pix_val_V_4_reg_340 : pixOut_val_V_14_fu_700_p3);

assign pixOut_val_V_16_fu_714_p3 = ((tobool_read_reg_835[0:0] == 1'b1) ? ap_phi_reg_pp0_iter3_pix_val_V_reg_376 : pixOut_val_V_13_fu_693_p3);
...
assign select_ln1946_fu_721_p3 = ((and10_i_read_reg_830[0:0] == 1'b1) ? 8'd0 : ap_phi_reg_pp0_iter3_pix_val_V_3_reg_357);
...
endmodule //vid_oe3_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_729_2
