...
entity vid_oe3_v_tpg_0_0_v_tpgHlsDataFlow is
port (
...
architecture behav of vid_oe3_v_tpg_0_0_v_tpgHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    component vid_oe3_v_tpg_0_0_tpgBackground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vid_oe3_v_tpg_0_0_tpgForeground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vid_oe3_v_tpg_0_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component vid_oe3_v_tpg_0_0_fifo_w24_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component vid_oe3_v_tpg_0_0_start_for_tpgForeground_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component vid_oe3_v_tpg_0_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    tpgBackground_U0 : component vid_oe3_v_tpg_0_0_tpgBackground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    tpgForeground_U0 : component vid_oe3_v_tpg_0_0_tpgForeground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2AXIvideo_U0 : component vid_oe3_v_tpg_0_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    bckgndYUV_U : component vid_oe3_v_tpg_0_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    ovrlayYUV_U : component vid_oe3_v_tpg_0_0_fifo_w24_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_tpgForeground_U0_U : component vid_oe3_v_tpg_0_0_start_for_tpgForeground_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component vid_oe3_v_tpg_0_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
