...
entity vid_oe3_v_tpg_0_0_tpgForeground is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of vid_oe3_v_tpg_0_0_tpgForeground is 
...
attribute shreg_extract : string;
    ...
    component vid_oe3_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_729_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_tpgForeground_Pipeline_VITIS_LOOP_729_2_fu_174 : component vid_oe3_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_729_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
