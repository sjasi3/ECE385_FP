...
// ==============================================================
#ifndef XVID_OE3_V_TPG_0_0_V_TPG_H
#define XVID_OE3_V_TPG_0_0_V_TPG_H
...
#include <stddef.h>
#endif
#include "xvid_oe3_v_tpg_0_0_v_tpg_hw.h"
...
typedef struct {
    u16 DeviceId;
    u64 Vid_oe3_v_tpg_0_0_ctrl_BaseAddress;
} XVid_oe3_v_tpg_0_0_v_tpg_Config;
#endif

typedef struct {
    u64 Vid_oe3_v_tpg_0_0_ctrl_BaseAddress;
    u32 IsReady;
} XVid_oe3_v_tpg_0_0_v_tpg;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XVid_oe3_v_tpg_0_0_v_tpg_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XVid_oe3_v_tpg_0_0_v_tpg_ReadReg(BaseAddress, RegOffset) \
...
/************************** Function Prototypes *****************************/
#ifndef __linux__
int XVid_oe3_v_tpg_0_0_v_tpg_Initialize(XVid_oe3_v_tpg_0_0_v_tpg *InstancePtr, u16 DeviceId);
XVid_oe3_v_tpg_0_0_v_tpg_Config* XVid_oe3_v_tpg_0_0_v_tpg_LookupConfig(u16 DeviceId);
