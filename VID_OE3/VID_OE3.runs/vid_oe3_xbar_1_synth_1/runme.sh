...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/VID_OE3/VID_OE3.runs/vid_oe3_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vid_oe3_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vid_oe3_xbar_1.tcl
