...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			...
			name vid_oe1_v_tpg_0_0_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler vid_oe1_v_tpg_0_0_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 269
set RegSliceName vid_oe1_v_tpg_0_0_regslice_both
set RegSliceInstName vid_oe1_v_tpg_0_0_regslice_both_U
set CoreName ap_simcore_vid_oe1_v_tpg_0_0_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
