...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/VID_OE1/VID_OE1.runs/vid_oe1_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vid_oe1_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vid_oe1_microblaze_0_1.tcl
