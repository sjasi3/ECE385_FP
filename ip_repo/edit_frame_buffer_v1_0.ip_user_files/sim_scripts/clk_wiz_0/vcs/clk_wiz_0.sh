...
#
# Generated by Vivado on Tue Nov 19 23:35:43 CST 2024
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../frame_buffer_1_0/src/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../frame_buffer_1_0/src/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
