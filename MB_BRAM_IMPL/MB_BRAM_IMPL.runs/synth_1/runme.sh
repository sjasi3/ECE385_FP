...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/MB_BRAM_IMPL/MB_BRAM_IMPL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_ddr3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_ddr3_top.tcl
