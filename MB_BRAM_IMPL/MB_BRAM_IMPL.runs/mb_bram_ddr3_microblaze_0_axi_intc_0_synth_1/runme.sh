...
HD_PWD='/home/sean/Downloads/git/ECE385_FP/MB_BRAM_IMPL/MB_BRAM_IMPL.runs/mb_bram_ddr3_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_bram_ddr3_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_bram_ddr3_microblaze_0_axi_intc_0.tcl
