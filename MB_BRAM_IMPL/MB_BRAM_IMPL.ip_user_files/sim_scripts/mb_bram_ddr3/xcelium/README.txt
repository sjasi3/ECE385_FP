...
#
# Generated by export_simulation on Tue Dec 03 19:19:08 CST 2024
#
################################################################################
...
'-reset_run' switch to the './mb_bram_ddr3.sh' script.

./mb_bram_ddr3.sh -reset_run
...
./mb_bram_ddr3.sh -noclean_files

For more information on the script, please type './mb_bram_ddr3.sh -help'.
