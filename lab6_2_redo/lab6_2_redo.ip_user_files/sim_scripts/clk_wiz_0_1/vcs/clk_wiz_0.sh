...
#
# Generated by Vivado on Fri Dec 06 18:13:02 CST 2024
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../lab6_2_redo.gen/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../lab6_2_redo.gen/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/sean/Downloads/git/ECE385_FP/lab6_2_redo/lab6_2_redo.cache/compile_simlib/vcs"
  fi
