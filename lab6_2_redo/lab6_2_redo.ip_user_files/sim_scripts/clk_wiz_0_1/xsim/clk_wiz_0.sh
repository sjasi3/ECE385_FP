...
#
# Generated by Vivado on Fri Oct 25 06:29:40 CDT 2024
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_usb.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/sean/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
